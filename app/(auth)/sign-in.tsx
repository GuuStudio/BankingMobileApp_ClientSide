        ...
        >
            <View >
                <SafeAreaView >
                    ...
                    <View className={` mt-8  rounded-2xl border border-main-200 justify-between`}
                        style={{
                            backgroundColor: 'rgba(255, 255, 255, 0.1)',
                        }}
                    >
                        <View className='w-full h-24 rounded-t-2xl px-8 flex-row  items-center bg-main-400'>
                            ...
                            <View className='pl-2'>
                                <Text className='text-white text-custom-color-2  text-md'>Back</Text>
                        ...
                        <Pressable
                            className='w-full h-16 bg-main-100 rounded-b-2xl justify-center items-center'
