    ...
    return (
        ...
        >
            <View className='px-6 gap-4  w-full h-full'>
                <View className={`flex-col rounded-md bg-white items-center border border-custom-border-2 p-4 w-full mt-24 gap-2`} >
                    ...
                    >
                        ...
                        />
                        <View className='bg-gray-100 shadow-md shadow-custom-shadow w-11 h-11 rounded-full justify-center items-center'
                            style={{
                                position: 'absolute',
                                bottom: 0,
                                right: 0
                    ...
                    <View className='flex-row w-full justify-between mt-2 items-center'>
                        ...
                        <View className='bg-white  border border-custom-border-2 flex-row  p-2 rounded-md w-44 gap-2' >
                            <Image
                    ...
                    <View className='mt-10 w-full bg-white rounded-md border border-custom-border-2 flex-row justify-between items-center p-4'>
